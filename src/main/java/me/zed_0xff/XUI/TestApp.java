    ...
    public static void main(String[] args) {
        ...
        ref[0] = new Session(win, () ->
            new Window(dx, dy, dw, dh, "Window")
                ...
                .addControl(w -> new Button(  w,  10,  40, 100, 40, "OK") { @Override protected void onClick() { ref[0].dismiss(); } })
                .addControl(w -> new CheckBox(w, 120,  10, 100, 20, "test"))
                .addRadioGroup(g -> { g.button(120, 40, 100, 20, "R1"); g.button(180, 40, 100, 20, "R2"); })
                .addRadioGroup(g -> { g.button(120, 70, 100, 20, "R3"); g.button(180, 70, 100, 20, "R4"); })
